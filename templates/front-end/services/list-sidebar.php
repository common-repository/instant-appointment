...
$annoncement_name = $_GET['s'];  
$annoncement_lieu = $_GET['localisation'];  
$annoncement_latitude = $_GET['latitude']; 
$annoncement_longitude = $_GET['longitude']; 
$annoncement_category = $_GET['category'];  
$annoncement_date_range = $_GET['date-range'];   

$author_selected = [];
$users = insapp_get_calendar_by_date($annoncement_date_range);
...
$author_ids_list = array();

if (!empty($annoncement_lieu)) {
	$author_args = array(
		'meta_query' => array(
			array(
				'key' => 'adresse',
				'value' => $annoncement_lieu,
				'compare' => '=', 
			),
		),
	);
...
<div class="insapp_listing_sidebar_page">
	<div class="row">
		<div class="ia-sidebar-listing col-lg-4 col-12">
		    ...
		    <h3 class="mt-4 d-lg-flex d-none">Que cherches-tu?</h3>
				...
				<div class="ia-listing-search-form">
					...
					<form id="ia-filter-listing-form" action="" class="form-search filter-listing-form style_df"
						...
						<div class="row">
							<div class="col-12 col-md-12 col-lg-12   ">
								<div class="form-group form-group-title">
									<input type="text" name="ia-filter-title" class="form-control " value="<?php echo !empty($annoncement_name)? $annoncement_name :'' ?>"
										id="ia-filter-title" placeholder="Mot Clé">
								</div>
							</div>
							<div class="col-12 col-md-12 col-lg-12">
								<div class="form-group form-group-category">
									<select id="ia-filter-category" name="ia-filter-category"  class="form-select"
										...
										<?php 
										 $selectcat = !empty($annoncement_category )? $annoncement_category  :'';
							...
							<div class="col-12 col-md-12 col-lg-12">
								<div class="form-group form-group-category">
								<label class="ia-heading-label "> Sois plus précis</label>
									<div class=" ">
							...
							<div class="col-12 col-md-12 col-lg-12   ">
						    	...
						    	<label class="ia-heading-label mb-3"> Où cherches-tu ? </label>
								<div class="ia-filter-location-card">
									<input type="text" name="ia-filter-lieu" class="ia-filter-lieu" value="<?php echo !empty($annoncement_lieu)? $annoncement_lieu :'' ?>"
										...
										<div id="ib-radius-dialog" class="ib-radius-dialog" title="Sélectionner le rayon">
                                        	...
                                        	<label class="ia-heading-label"> Délimite ta recherche : </label>
							...
							<div class="col-12 col-md-12 col-lg-12   ">
									...
									<div class="ia-price-wrapper ia_price_range_block">
										...
										<label class="ia-heading-label mb-3"> <?php _e('Quel est ton budget ?'); ?></label>
							...
							<div class="col-12 col-md-12 col-lg-12   ">
								<div class="form-group form-group-title">
									<input type="text" name="ia-filter-date_annonce" class="form-control " value="<?php echo !empty($annoncement_date_range )? $annoncement_date_range  :'' ?>"
										id="ia-filter-date_annonce" placeholder="Pour quand cherches-tu ?"> 
								</div>
							</div>
							<div class="col-12 col-md-12 col-lg-12">
					...
					$paged = (get_query_var('paged')) ? get_query_var('paged') : 1;
                      ...
                      //     'key' => '_annonce_medium',
                        ...
                        //   ),
								...
								if (!empty($annoncement_category)) { 
									$argsAn['tax_query'] = array(
										array(
											'taxonomy' => 'product_cat', 
											'field'    => 'term_id', 
											'terms'    => $annoncement_category, 
										),
									);
								}
								if (!empty($annoncement_name)) {
									$argsAn['s'] = $annoncement_name;
								}
								  
								
								if (!empty($author_selected)) {
									$argsAn['author__in'] = $author_selected;
								}  
								if ($annoncement_lieu){
                                        $radius = 10;
                                        $bracket = getBoundingBox($annoncement_latitude, $annoncement_longitude,$radius) ;
